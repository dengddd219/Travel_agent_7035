...
────────────────────────────────────────────────────────────────────────
  strategy_queries: ["成都 family attraction", "成都 亲子游", "成都 3天 行程", "成都 高预算 玩法"]
  geo_queries: ["Chengdu 亲子景区"]
  condition_queries: {"weather": {"city": "Chengdu", "trip_days": 3, "start_date": "", "focus": "general"},
    "cost": {"city": "Chengdu", "days": 3, "budget_level": "high", "travelers": "friends",
    "user_budget": null}}
...
────────────────────────────────────────────────────────────────────────
  ...
  travel_type: family
  top_k: 5
  queries: ["成都 family attraction", "成都 亲子游", "成都 3天 行程", "成都 高预算 玩法"]

Loading weights: 100%|███████████████████████████████████████████████████████████████████████████████████| 71/71 [00:00<00:00, 1807.32it/s]
...
────────────────────────────────────────────────────────────────────────
  ...
  source: search_notes
  total_chunks: 5
  recommended_pois: ["黄鹤楼", "东湖绿道", "昙华林", "古隆中", "襄阳古城", "米公祠", "兵马俑", "碑林博物馆", "OnlyBashi coffee(桐梓林店)",
    "春熙路", "IFC", "3D裸眼大屏"]
  theme_suggestions: ["family", "leisure", "成都", "culture", "food", "美食"]
  ...
  Per-query diagnostics:
    ...
    • [group_a_search_notes] score_count=5
      query: 成都 3天 行程
      top chunks: ['842c6c04231b_005', 'b558375bb571_002', '842c6c04231b_004']
    • [group_a_search_notes] score_count=5
      query: 成都 高预算 玩法
      top chunks: ['504f738ecd62_007', '910d8081eaf5_006', '90ed0036968f_002']
  Top-3 raw chunks:
    [1] score=0.0160  chunk_id=edd99cb58627_004
        【🌆恋爱脑版全国环线游】 📍 成都 景点：熊猫基地、金沙遗址、锦里 美食：火锅、串串、甜水面 体验：鹤鸣茶馆盖碗茶、川剧化妆体验…
    [2] score=0.0160  chunk_id=7d35a3c07cb3_001
    ...
    [3] score=0.0158  chunk_id=842c6c04231b_005
...
────────────────────────────────────────────────────────────────────────
  ...
  result_summary: {"city": "Chengdu", "forecast": [{"date": "2026-04-25", "summary": "多云", "temp_min": 16.0,
    "temp_max": 30.0, "precipitation_probability": 35, "outdoor_suitability": "good",
    ...
    one indoor backup and front-load outdoor stops."], "source": "amap_api"}, {"date":
    "2026-04-27", "summary": "小雨", "temp_min": 15.0, "temp_max": 26.0,
    "precipitation_probability": 60, "outdoor_suitability": "mixed", "suggestions":
    ["天气舒适，适合穿长袖；有降水，建议带伞，安排室内活动", "Keep one indoor backup and front-load outdoor
    stops."], "source": "amap_api"}]}
...
────────────────────────────────────────────────────────────────────────
  arguments: {"city": "Chengdu", "days": 3, "budget_level": "high"}
...
────────────────────────────────────────────────────────────────────────
  rag_recommended_pois (fed to planner): ["黄鹤楼", "东湖绿道", "昙华林", "古隆中", "襄阳古城", "米公祠", "兵马俑", "碑林博物馆", "OnlyBashi coffee(桐梓林店)",
    "春熙路", "IFC", "3D裸眼大屏"]
  neighborhood_notes_count: 0
  total_pois_before_select: 7
...
────────────────────────────────────────────────────────────────────────
  total_days: 3
  Day 1: 武侯区 | Family
    POIs: ['新场黄鹤楼', "People's Park Chengdu", '隆中茶舍', '锦江绿道']
  Day 2: Qingyang | Family
    POIs: ['Taikoo Li Chengdu', '隆中对']
  Day 3: Chenghua | Family
    POIs: ['Chengdu Research Base of Giant Panda Breeding']
...
INFO:     127.0.0.1:53070 - "POST /api/chat HTTP/1.1" 200 OK