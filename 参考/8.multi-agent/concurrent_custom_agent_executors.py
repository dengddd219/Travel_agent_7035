...
Demonstrates:
- Executors that create their Agent in __init__ 
...
class ResearcherExec(Executor):
    ...
    def __init__(self, client: OpenAIChatClient, id: str = "researcher"):
        self.agent = Agent(
            client=client,
            instructions=(
...
class MarketerExec(Executor):
    ...
    def __init__(self, client: OpenAIChatClient, id: str = "marketer"):
        self.agent = Agent(
            client=client,
            instructions=(
...
class LegalExec(Executor):
    ...
    def __init__(self, client: OpenAIChatClient, id: str = "legal"):
        self.agent = Agent(
            client=client,
            instructions=(
